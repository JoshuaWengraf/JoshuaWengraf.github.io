...
For my MSc project I measured magnetophonon oscillations with a large applied DC bias voltage. We found we can use the DC bias voltage to tune the energy of the measurement. This work was supervised by Dr Leonid Ponomarenko, Prof. Laurence Eaves, and Prof. Sir Andre Geim.
